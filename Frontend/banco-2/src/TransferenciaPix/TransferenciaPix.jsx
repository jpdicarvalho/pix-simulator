...
function TransferenciaPix () {
    ...
    const searchClient = () =>{
        axios.get(`http://localhost:5002/api/v1/searchClientByPixKey/${pixKey}`)
        .then(res => {
            console.log(res)
    ...
    const transferirPix = () =>{
        ...
        axios.put(`http://localhost:5002/api/v1/transferenciaPix`, values)
        .then(res => {
                    ...
                    {sucessRequest ? (
                        <div className="container__sucess__transation">
                            <div className="box__icon__and__text">
                                ...
                                <h2 style={{color: '#168200'}}>Pagamento realizado com sucesso!</h2>
                            </div>
